...
// Дополняет Форму кнопкой ПересчитатьТаблицу
// Параметр: 
...
Процедура ДобавитьКомандуПересчитатьТаблицу(Форма);
	...
	КнопкаКоманды = Форма.Элементы.Добавить("КнопкаПересчитатьТаблицу",Тип("КнопкаФормы"),Форма.Элементы.ГруппаПересчет);
